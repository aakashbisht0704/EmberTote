import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-LLDMALFC.js";
import "./chunk-UWE45W7O.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-WB2CG2IP.js")),
  document: (0, import_react.lazy)(() => import("./pane-6FLRZD5X.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-6FLRZD5X.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-ZCXUGYFP.js"))
};
...
//# sourceMappingURL=index3-VFNVCQS6.js.map
